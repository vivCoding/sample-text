...
class User:
    ...
    def __init__(self, username, email, password, name="", bio="", profile_img="", following=[], followers=[], followed_topics = [], posts=[], liked_posts=[], loved_posts=[], comments=[], saved_posts=[], user_id="") -> None:
